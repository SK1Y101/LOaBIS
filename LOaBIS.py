...
def elog(err="",sy=1):
    ...
    if sy:
        say("Software encountered an error, consider submitting log to developers","Error")

def say(txt="",cli="System",console=0):
    try:
        text.insert(END,txt)
    except:
...
if __name__=="__main__":
    try:
        ...
        log("Function initialisation complete, took "+str(import_time[0]*60+import_time[1])+" seconds")
